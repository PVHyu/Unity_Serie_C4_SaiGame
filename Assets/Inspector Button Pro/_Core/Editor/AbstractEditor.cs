...
namespace com.cyborgAssets.internalIBPEditor
{
    public abstract class AbstractEditor : UnityEditor.Editor
    {
        ...
        private static int GetObjectCacheId(UnityEngine.Object targetObject)
        {
            if (targetObject == null)
                return 0;

            return targetObject.GetEntityId().GetHashCode();
        }
        ...
        private void OnEnable()
        {
            ...
            var objectID = GetObjectCacheId(serializedObject.targetObject);
        ...
        private void TryAddObjectToCacheMine(UnityEngine.Object targetObjectMine)
        {
            ...
            var objectID = GetObjectCacheId(targetObjectMine);
                ...
                if (buttonPressed)
                {
                    ...
                    else
                    {
                        foreach (var targetObject in serializedObject.targetObjects)
                        {
                            ...
                            var targetParameters = cache[GetObjectCacheId(targetObject)][methodParams.Key];
